...
class unitMainTable extends StatefulWidget {
  const unitMainTable({Key? key}) : super(key: key);

  @override
  State<unitMainTable> createState() => _unitMainTableState();
}

class _unitMainTableState extends State<unitMainTable> {
  Leds? ledColors;
  ...
  void getData() async {
    ledColors = (await ApiService().getLeds3())!;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Nagy asztal vezérlés"),
      ),
      body: ledColors == null
          ? const Center(
