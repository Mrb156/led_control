...
void pat()
{
  fill_palette(leds, NUM_LEDS, led_source.paletteIndex, 1, myPal, led_source.br, LINEARBLEND);
  FastLED.setBrightness(led_source.br);
  FastLED.show();
}
void g_wave()
{
  ...
  fill_palette(leds, NUM_LEDS, (beatA + beatB) / 2, 10, myPal, led_source.br, LINEARBLEND);
  FastLED.setBrightness(led_source.br);
  FastLED.show();
}
////////////////////////
